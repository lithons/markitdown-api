...
/**
 * Instantiates a new {@link MarkItDownApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createMarkItDownApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<MarkItDownApiClient>(requestAdapter, pathParameters, MarkItDownApiClientNavigationMetadata, MarkItDownApiClientRequestsMetadata);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface MarkItDownApiClient extends BaseRequestBuilder<MarkItDownApiClient> {
    /**
 ...
 */
export const MarkItDownApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const MarkItDownApiClientNavigationMetadata: Record<Exclude<keyof MarkItDownApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    convert: {
 ...
 */
export const MarkItDownApiClientRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: MarkItDownApiClientUriTemplate,
